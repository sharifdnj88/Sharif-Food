                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title">All Food Menu</h4>
                            <a href="" class="font-weight-bold btn btn-danger">Trash Food-Menu <i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($food as $item)
                                            <tr>
                                                <td>{{ $loop -> index + 1 }}</td>
                                                <td>{{ $item -> title }}</td>
                                                <td> <img style="max-width: 80px;box-shadow:0px 0px 10px 0px rgba(0,0,0,0.5);border-radius:5%;padding:3px;border:1px solid red" src="{{ url('storage/foods/'. $item -> photo) }}" alt=""> </td>
