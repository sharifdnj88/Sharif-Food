                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="" class="font-weight-bold btn btn-danger">Trash Food Category <i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add new Food-Category</h4>
                        </div>
                        <div class="card-body">
                            @include('validate')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include('validate')
                            <form action="{{route('food-category.update', $edit -> id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label>Name</label>
                                ...
                                <div class="text-right">
                                    <a class="btn btn-warning" href="{{route('food-category.index')}}">Back</a>
